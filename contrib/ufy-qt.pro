...
RESOURCES += src/qt/ufy.qrc src/qt/ufy_locale.qrc

TRANSLATIONS += src/qt/locale/ufy_bg.ts \
                src/qt/locale/ufy_de.ts \
                src/qt/locale/ufy_en.ts \
                src/qt/locale/ufy_es.ts \
                src/qt/locale/ufy_fi.ts \
                src/qt/locale/ufy_fr.ts \
                src/qt/locale/ufy_it.ts \
                src/qt/locale/ufy_ja.ts \
                src/qt/locale/ufy_pl.ts \
                src/qt/locale/ufy_pt.ts \
                src/qt/locale/ufy_ru.ts \
                src/qt/locale/ufy_sk.ts \
                src/qt/locale/ufy_sv.ts \
                src/qt/locale/ufy_vi.ts \
                src/qt/locale/ufy_zh_CN.ts \
                src/qt/locale/ufy_zh_TW.ts
