...
In order to support loading of multiple wallets in ufy-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ufy.cpp.
...
Changes to ufy.cpp
----------------------
ufy.cpp is the entry point into ufy-qt, and as such, will require some minor modifications to provide hooks for
