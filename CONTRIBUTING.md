Contributing to UnifyCoin Core
============================

The UnifyCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UnifyCoin Core project, and is not to be
confused with overall UnifyCoin Network Protocol consensus changes.

Whether a pull request is merged into UnifyCoin Core rests with the project merge
...
Patches that change UnifyCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the UnifyCoin consensus, it must have been
...
The project leader is the release manager for each UnifyCoin Core release.
