...
extern UniValue setzufyseed(const UniValue& params, bool fHelp);
extern UniValue getzufyseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzufy(const UniValue& params, bool fHelp);
extern UniValue dzufystate(const UniValue& params, bool fHelp);
