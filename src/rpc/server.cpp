...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* UFY features */
        {"ufy", "masternode", &masternode, true, true, false},
        {"ufy", "listmasternodes", &listmasternodes, true, true, false},
        {"ufy", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ufy", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ufy", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ufy", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ufy", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ufy", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ufy", "masternodedebug", &masternodedebug, true, true, false},
        {"ufy", "startmasternode", &startmasternode, true, true, false},
        {"ufy", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ufy", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ufy", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ufy", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ufy", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ufy", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ufy", "mnbudget", &mnbudget, true, true, false},
        {"ufy", "preparebudget", &preparebudget, true, true, false},
        {"ufy", "submitbudget", &submitbudget, true, true, false},
        {"ufy", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ufy", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ufy", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ufy", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ufy", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ufy", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ufy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ufy", "checkbudgets", &checkbudgets, true, true, false},
        {"ufy", "mnsync", &mnsync, true, true, false},
        {"ufy", "spork", &spork, true, true, false},
        {"ufy", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ufy-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51229/\n";
}
