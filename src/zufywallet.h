...
#ifndef UFY_ZUFYWALLET_H
#define UFY_ZUFYWALLET_H
...
public:
    CzUFYWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZUFY(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZUFY(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
