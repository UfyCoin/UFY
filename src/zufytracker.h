...
#ifndef UFY_ZUFYTRACKER_H
#define UFY_ZUFYTRACKER_H
...
public:
    CzUFYTracker(std::string strWalletFile);
    ~CzUFYTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzUFYWallet* zUFYWallet = NULL);
