...
/* UnifyCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "UFY"
#define QAPP_ORG_DOMAIN "ufycoin.com"
#define QAPP_APP_NAME_DEFAULT "UFY-Qt"
#define QAPP_APP_NAME_TESTNET "UFY-Qt-testnet"
