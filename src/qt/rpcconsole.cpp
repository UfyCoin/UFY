                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzUFYPathCustom = GetArg("-zufybackuppath", "");
    ...
    if(!strzUFYPathCustom.empty()) {
        ui->wallet_customzufybackuppath->setText(QString::fromStdString(strzUFYPathCustom));
        ui->wallet_customzufybackuppath_label->setVisible(true);
        ui->wallet_customzufybackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzUFYPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the UFY RPC console.") + "<br>" +
