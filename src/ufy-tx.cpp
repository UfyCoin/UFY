...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("UnifyCoin Core ufy-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ufy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ufy transaction") + "\n" +
                               "  ufy-tx [options] -create [commands]   " + _("Create hex-encoded ufy transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ufy transaction
